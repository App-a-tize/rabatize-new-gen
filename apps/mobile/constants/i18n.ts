...
export const translations = {
  en: {
    ...
    'game.close': 'Close',
    'game.recordHint': 'Select who drank. It saves when you draw the next card.',
  ...
  fr: {
    ...
    'game.close': 'Fermer',
    'game.recordHint': 'Sélectionne qui boit. C’est enregistré quand tu passes à la carte suivante.',
